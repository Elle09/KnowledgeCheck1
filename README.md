...
- [see style2.css ] 2. Center div `hero-content` in `hero` section
- [x] 3. Change `Hero` button `:hover` colors.
- [yes but change it again] 4. Change photo in `About Me` section.
- [Made html page, need content] 5. BONUS: Add a `Contact` section.
